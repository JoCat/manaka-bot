...
export class ConfigManager {
    private configFile = path.resolve(__dirname, '..', 'bot_config.json')
    ...
    private load(): void {
        ...
        try {
            ...
            if (e instanceof SyntaxError) {
                console.error("Json syntax broken. Try fix or delete LauncherServerConfig.json")
                console.error(e)
            }
        }
    }
